...
// THE OUTPUTS OF THE DISPLAY DRIVERS SHOULD CORRESPOND TO A SET OF DRIVERS FOR THE SEVEN SEGMENT DISPLAYS.
	...
	sevensegdecoder_proc_bdeduffy HEXDEC0(count[3:0], HEX0);
	sevensegdecoder_proc_bdeduffy HEXDEC1(count[7:4], HEX1);
	sevensegdecoder_proc_bdeduffy HEXDEC2(count[11:8], HEX2);
	sevensegdecoder_proc_bdeduffy HEXDEC3(count[15:12], HEX3);
